...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Parcel status and pickup rules                | Date-only status logic, picked-up/not-picked-up transitions, public and admin display consistency | Completed   | Admin household status follows date-only display; pickup/no-show mutations are centralized. Public parcel status intentionally uses pickup-window/expiry semantics and now has focused tests. |
| Household management                          | Household actions, eligibility, member/contact fields, deletion/archive behavior                  | In progress | Removed an unreferenced legacy household-detail component with stale parcel status behavior.                                                                                                  |
