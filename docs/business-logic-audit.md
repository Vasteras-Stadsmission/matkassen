...
| Handout locations                             | Location availability, assignment rules, related parcel constraints                               | In progress | `/settings/locations` is the only rendered location-management surface; the old `/handout-locations` URL redirects there.                                                                     |
...
| 2026-06-20 | Handout locations              | Collapsed the legacy `/handout-locations` page into a locale-aware redirect to `/settings/locations`, deleted the unused page wrapper and transition skeleton branch, and removed duplicated cache revalidation for the old path.                                                                           | `pnpm run validate`                                                                                                                                                                                                                                                                                               |
