    ...
    it("should handle API returning only inactive questions (edge case)", async () => {
        ...
        vi.mocked(global.fetch).mockResolvedValueOnce({
            ...
            json: async () => [
                {
                    id: "q1",
                    question_text_sv: "Inactive Question 1",
                    question_text_en: "Inactive Question 1",
                    help_text_sv: null,
                    help_text_en: null,
                    is_required: true,
                    is_active: false,
                ...
                {
                    id: "q2",
                    question_text_sv: "Inactive Question 2",
                    question_text_en: "Inactive Question 2",
                    help_text_sv: null,
                    help_text_en: null,
                    is_required: false,
                    is_active: false,
