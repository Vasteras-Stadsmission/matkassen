/**
 * Integration tests for fully-booked-date functionality.
 *
 * Tests the getFullyBookedDates server action against
 ...
 * - Date-specific limits overriding the location default
 * - Edge cases such as unlimited locations and empty dates
 */
...
import { getFullyBookedDates } from "@/app/[locale]/schedule/actions";
